        ...
        <div id='contact' className="container flex flex-col h-screen">
            <div className="relative flex flex-col justify-between bg-white-regular h-[50%] overflow-hidden">
                ...
                md:mt-24 md:gap-[42px]">
                    <img className='md:w-16 md:h-16' src={htmlSvg} alt="html svg" />
                    <img className='md:w-16 md:h-16' src={cssSvg} alt="css svg" />
                    <img className='md:w-16 md:h-16' src={jsSvg} alt="js svg" />
                    <img className='md:w-16 md:h-16' src={reactSvg} alt="react svg" />
                    <img className='md:w-16 md:h-16' src={tailwindSvg} alt="tailwind svg" />
                    <img className='md:w-16 md:h-16' src={bootstrapSvg} alt="bootstrap svg" />
                    <img className='md:w-16 md:h-16' src={phpSvg} alt="php svg" />
                </section>
                <p className='text-[32px] p-4 flex align-center justify-center
                md:text-[44px] md:mb-8'>Tem uma ideia de projeto legal?</p>
            </div>
            <footer className='relative flex flex-col h-[50%] justify-between place-items-center bg-gray-dark overflow-hidden'>
                ...
                <p className='flex text-[32px] p-4 underline text-primary-regular
                md:text-[44px] md:mt-[34px]'>joaovsbraz@gmail.com</p>
