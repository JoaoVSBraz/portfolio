    ...
    return (
        <div id='contact' className="container flex flex-col h-screen">
            <div className="bg-white-regular h-[50vh]">
                <section id="skills" className="flex align-center justify-center gap-8 overflow-x-hidden mt-20 mb-8 p-6">
                ...
                <p className='text-[32px] p-4 flex align-center m-auto'>Tem uma ideia de projeto legal?</p>
            </div>
            <footer className='flex flex-col h-full justify-between place-items-center bg-gray-dark'>
                <p className='flex text-[32px] p-4 underline text-primary-regular'>joaovsbraz@gmail.com</p>
