    ...
    return (
        <div id='contact' className="flex flex-col h-screen">
            <div className="relative flex flex-col justify-between bg-white-regular h-[50%] overflow-hidden">
                ...
                <section id="skills" className="flex align-center justify-center gap-8 overflow-x-hidden mt-20 p-6
                md:mt-24 md:gap-[42px]
                xl:gap-24
                2xl:gap-40">
                    <img className='md:w-16 md:h-16 xl:w-24 xl:h-24' src={htmlSvg} alt="Icone vetorial da linguagem de marcação html" />
                    <img className='md:w-16 md:h-16 xl:w-24 xl:h-24' src={cssSvg} alt="Icone vetorial da linguagem de estilização css" />
                    <img className='md:w-16 md:h-16 xl:w-24 xl:h-24' src={jsSvg} alt="Icone vetorial da linguagem de programação javascript" />
                    <img className='md:w-16 md:h-16 xl:w-24 xl:h-24' src={reactSvg} alt="Icone vetorial da biblioteca react" />
                    <img className='md:w-16 md:h-16 xl:w-24 xl:h-24' src={tailwindSvg} alt="Icon vetorial do framework css tailwind" />
                    <img className='md:w-16 md:h-16 xl:w-24 xl:h-24' src={gitSvg} alt="Icone vetorial da ferramenta de versionamento git" />
                    <img className='md:w-16 md:h-16 xl:w-24 xl:h-24' src={phpSvg} alt="Icone vetorial da linguagem de programação php" />
                </section>
            ...
            <footer className='relative flex flex-col h-[50%] justify-between place-items-center bg-gray-dark overflow-hidden'>
                <div className='hidden md:block md:absolute md:h-[calc(100vh - 50%)] md:right-0 md:bottom-20 md:z-0 rotateXY-180'>
