export default function FirstScreen(){
    ...
    return (
        <div className="container flex flex-col h-screen">
            <header className="fixed bg-white-regular border-b-[1px] border-white-dark w-full h-fit flex align-center justify-between p-4 text-center z-50" onClick={handleMenuClick}>
            ...
            <section id="hero" className="container bg-white-regular text-gray-dark flex flex-col h-full mt-[65px]">
                <div>
                ...
                <div>
                    ...
                    <div className="flex justify-evenly">
                        <button type="button" className="py-2 px-4 bg-primary-regular border-4"><a href="#contact" className="w-full h-full">CONTATO</a></button>
                        <button type="button" className="py-2 px-4 bg-primary-regular border-4"><a href="#">DOWNLOAD CV</a></button>
                    </div>
                </div>
